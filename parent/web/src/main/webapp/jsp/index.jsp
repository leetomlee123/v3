        ...
        <div class="col-md-10">
            ...
            <c:forEach items="${hotProductList }" var="hotPro">
                ...
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    <a href="${pageContext.request.contextPath }/product/productInfo?pid=${hotPro.pid}&cid=${hotPro.cid}&currentPage=1">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            ...
            <c:forEach items="${newProductList }" var="newPro">
                ...
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    <a href="${pageContext.request.contextPath }/product/productInfo?pid=${newPro.pid}&cid=${newPro.cid}&currentPage=1">
